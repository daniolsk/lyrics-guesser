	...
	return (
		<div className="flex flex-col justify-between min-h-screen">
			<main className={`flex-1 flex flex-col justify-center items-center p-5 ${inter.className}`}>
				...
				<div className="text-lg font-semibold mb-8 text-center">Check how well you know your favorite artist</div>
				<form className="flex flex-col" onSubmit={(e) => handleSubmit(e)}>
					<div className="flex mb-4">
						<input
							type="text"
							className="bg-transparent border-b-2 text-xl text-center p-2"
